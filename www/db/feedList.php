...
if ($result -> num_rows){
    ...
    $query2="INSERT INTO musics (`idmusics`,`ref`,`name`,`artist`,`album`,`link`,`date`) VALUES ('','$id','$name','$artist','$album','$url','$date')";
    ...
    $query4="INSERT INTO posts (`idPOSTS`,`link`,`date`,`decaWeb`,`USERS_idUSERS`,`LOCATIONS_idLOCATIONS`,`MUSICS_idmusics`) VALUES ('','','$date','0','$idUser','1','$row1[0]')";
    echo $query4;
